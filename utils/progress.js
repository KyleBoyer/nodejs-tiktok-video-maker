...
function ProgressBar(fmt, options) {
  ...
  this.fmt = fmt;
  this.clearProgressOnComplete = options.clearProgressOnComplete;
...
ProgressBar.defaultWithLabel = function(label, extraOptions = {}){
...
ProgressBar.prototype.render = function (tokens, force) {
  ...
  var str = this.fmt
    ...
    .replace(':elapsed', isNaN(elapsed) ? '0.0' : toHHMMSS((elapsed / 1000).toFixed(1)))
    .replace(':eta', (isNaN(eta) || !isFinite(eta)) ? '--:--:--' : toHHMMSS((eta / 1000).toFixed(1)))
